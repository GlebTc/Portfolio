    ...
    return (
        <section id={id} className="about__container">
            ...
            <p className="about" id={title}>
                ...
                <br /><br />
                I have experience working individually, as part of a team, and as a member of a large organization. Working individually, I am <span>very organized</span>, <span>detail oriented</span> and committed to <span>high level of efficiency</span>. As part of a team, I am very <span>supportive</span>, embrace constructive criticism and always ready to assist.
            </p>
        </section>
    )
}
