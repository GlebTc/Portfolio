...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        // Switch track color in dark mode
        backgroundColor: 'rgb(16, 39, 16)',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    // This is the switch bgc
    backgroundColor: 'rgba(12, 76, 12, 1)',
    width: 20,
    height: 20,
  ...
  '& .MuiSwitch-track': {
    opacity: 1,
    backgroundColor: 'rgba(166, 216, 212, 1)',
    borderRadius: 20 / 2,
  },
}));
